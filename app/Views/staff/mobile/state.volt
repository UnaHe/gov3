        ...
        <form action="" id="edit_form">
            ...
            <div class="Selection_Time">
                <div class="Start_Time clear">
                    <input type="text"  name="start_date" value="{{ old_info.start_time is defined and old_info.start_time ? date('Y-m-d', old_info.start_time) : null }}" placeholder="开始日期" readonly>
                    <span class="Start_Time_img start_date"><img src="{{url('staff/style/img/time1_03.png')}}"></span>

                    <input type="text" name="start_time" value="{{ old_info.start_time is defined and old_info.start_time ? date('H:i', old_info.start_time) : null }}" placeholder="时间" readonly>
                    <span class="Start_Time_img start_time"><img src="{{url('staff/style/img/time2_03.png')}}"></span>
                </div>
            </div>
            <div class="Selection_Time">
                <div class="Start_Time clear">
                    <input type="text" name="end_date" value="{{ old_info.end_time is defined and old_info.end_time ? date('Y-m-d', old_info.end_time) : null }}" placeholder="结束日期" readonly>
                    <span class="Start_Time_img end_date"><img src="{{url('staff/style/img/time1_03.png')}}"></span>

                    <input type="text" name="end_time" value="{{ old_info.end_time is defined and old_info.end_time ? date('H:i', old_info.end_time) : null }}" placeholder="时间" readonly>
