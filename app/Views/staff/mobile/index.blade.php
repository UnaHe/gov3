...
@section('content')
                ...
                <div class="main">
                    ...
                    <div class="CurrentState y_CurrentState">
                        <div class="CurrentState_title y_CurrentState_title">
                            ...
                            <span class="CurrentState_d CurrentState_e"
                                  onclick="location.href='{{url('staff/edit_comments')}}'"><img
                                        src="../staff/style/img/bj.png"></span>
                        ...
                        <div class="CurrentState_title">
                            ...
                            @if(!empty($data['comments']))
                                @foreach($data['comments'] as $v)
                                    <p class="MessageArea">
                                        <a onclick=" location.href = '{{url('staff/commentone?comment_id='.$v['comment_id'])}}';">{{$v['comment_name']}}</a><a
                                                onclick=" location.href = '{{url('staff/commentone?comment_id='.$v['comment_id'])}}';"
                                                class="{{$v['comment_status']==0 ? 'unread' : 'read'}}">{{$v['comment_status']==0 ? '未处理' : '已处理'}}
                                        </a>
                                    </p>
                                    <span class="CurrentState_font"
                                          onclick=" location.href = '{{url('staff/commentone?comment_id='.$v['comment_id'])}}';">
                                {{$v['comment_content']}}
                            </span>
                                @endforeach
    ...
    {{--<link rel="stylesheet" href="{{asset('org/minirefresh/minirefresh.css')}}">--}}
    {{--<script src="{{asset('org/minirefresh/minirefresh.js')}}"></script>--}}
