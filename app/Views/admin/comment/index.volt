...
{% block content %}
                ...
                <tr>
                    ...
                    <td>
                        <select id="statusselect" name="status">
                            ...
                            <option value="1" {{( input['status'] is not empty and input['status'] == 1 ) ? 'selected' : ''}}>
                                已处理
                            </option>
                            <option value="0" {{( input['status'] is defined and input['status'] == 0 ) ? 'selected' : ''}}>
                                未处理
                            </option>
                        </select>
                    </td>
                    ...
                    <td>
                        <input type="text" id="key_words" name="key_words" placeholder="可搜索姓名，内容，电话"
                               value="{{ input['key_words'] is not empty ? input['key_words'] : ''}}"><br>
                    </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="testSelect"
                                ...
                                <option value="0" {{ v.comments.comment_status == 0 ? 'selected' : '' }} style="color: red">未处理</option>
                                <option value="1" {{ v.comments.comment_status == 1 ? 'selected' : '' }} style="color: green">已处理</option>
                            </select>
                        </td>
                ...
                <div style="float: right">
                    <ul class="paginate">
                        ...
                        {% if input['project_id'] is defined or input['section_id'] is defined or input['department_id'] is defined or input['status'] is defined or input['key_words'] is defined %}
                            ...
                            {% else %}
                                <li><a href="/admin/comment?project_id={{ input['project_id'] is defined ? input['project_id'] : '' }}&section_id={{ input['section_id'] is defined ? input['section_id'] : '' }}&department_id={{ input['department_id'] is defined ? input['department_id'] : '' }}&status={{ input['status'] is defined ? input['status'] : '' }}&key_words={{ input['key_words'] is defined ? input['key_words'] : '' }}&page=1">第一页</a></li>
                            {% endif %}
                            {% if data['list'].current == 1 %}
                                <li class="disabled"><span>上一页</span></li>
                            {% else %}
                                <li><a href="/admin/comment?project_id={{ input['project_id'] is defined ? input['project_id'] : '' }}&section_id={{ input['section_id'] is defined ? input['section_id'] : '' }}&department_id={{ input['department_id'] is defined ? input['department_id'] : '' }}&status={{ input['status'] is defined ? input['status'] : '' }}&key_words={{ input['key_words'] is defined ? input['key_words'] : '' }}&page={{ data['list'].before }}">上一页</a></li>
                            {% endif %}
                            {% if data['list'].current == data['list'].last or data['list'].last == 0 %}
                                <li class="disabled"><span>下一页</span></li>
                            {% else %}
                                <li><a href="/admin/comment?project_id={{ input['project_id'] is defined ? input['project_id'] : '' }}&section_id={{ input['section_id'] is defined ? input['section_id'] : '' }}&department_id={{ input['department_id'] is defined ? input['department_id'] : '' }}&status={{ input['status'] is defined ? input['status'] : '' }}&key_words={{ input['key_words'] is defined ? input['key_words'] : '' }}&page={{ data['list'].next }}">下一页</a></li>
                            {% endif %}
                            {% if data['list'].current == data['list'].last or data['list'].last == 0 %}
                                <li class="disabled"><span>最后一页</span></li>
                            {% else %}
                                <li><a href="/admin/comment?project_id={{ input['project_id'] is defined ? input['project_id'] : '' }}&section_id={{ input['section_id'] is defined ? input['section_id'] : '' }}&department_id={{ input['department_id'] is defined ? input['department_id'] : '' }}&status={{ input['status'] is defined ? input['status'] : '' }}&key_words={{ input['key_words'] is defined ? input['key_words'] : '' }}&page={{ data['list'].last }}">最后一页</a></li>
                            {% endif %}
                        {% else %}
                            {% if data['list'].current == 1 %}
                                <li class="disabled"><span>第一页</span></li>
    ...
    <script>
        ...
        function changePage(page) {
            ...
            location.href = "/admin/comment?project_id={{ input['project_id'] is defined ? input['project_id'] : '' }}&section_id={{ input['section_id'] is defined ? input['section_id'] : '' }}&department_id={{ input['department_id'] is defined ? input['department_id'] : '' }}&status={{ input['status'] is defined ? input['status'] : '' }}&key_words={{ input['key_words'] is defined ? input['key_words'] : '' }}&page=" + page;
        }
