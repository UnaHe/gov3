...
<div class="result_wrap">
    <form action="{{url('admin/users/' ~ field.user_id)}}" method="post" enctype="multipart/form-data" id="add-form" name="add-form">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    ...
                    <img alt="" id="previewImage"  src="{{Config("constants.upload_url") ~ field.user_image}}" style="max-width: 75px; max-height:100px;display:{% if field.user_image is empty %} 'none' {% endif %}">
                    <input type="button" value="移除图片" class="btn_remove back btn btn-info" style="display: {% if field.user_image is empty %} 'none' {% endif %}">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="user_sex" id="user_sex_1" value="1" {% if field.user_sex == 1 %} 'checked'="true" {% endif %} required/><label for="user_sex_1" >男</label>
                    <input type="radio" name="user_sex" id="user_sex_0" value="0" {% if field.user_sex == 0 %} 'checked'="true" {% endif %} required/><label for="user_sex_0">女</label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="user_status" id="user_status_1" value="1" {% if field.user_status == 1 %} 'checked'="true" {% endif %} required/><label for="user_status_1">正常在职</label>
                    <input type="radio" name="user_status" id="user_status_0" value="0" {% if field.user_status == 0 %} 'checked'="true" {% endif %} required/><label for="user_status_0">不在职</label>
            </tr>
            <tr class="project_type">
                <th>职务：</th>
                <td>
