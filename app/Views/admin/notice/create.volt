...
{% block content %}
    ...
    <!--结果集标题与导航组件 结束-->
    <div class="result_wrap">
        <form action="{{ url('admin/notice') }}" method="POST" id="add_form">
            ...
            <table class="add_tab">
                <tbody>
                        ...
                        <td class="department_list">
                            ...
                            <div class="tab-pane fade in active" id="department">
                                <div style="" class="nav-tabs">
                                    ...
                                    <input type="checkbox" style="margin-right:60px;" class="checkAll" id="checkAll">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="notice_title" style="width: 500px" required/>
                        </td>
                    </tr>
                    <tr>
                        <th>告示详情：</th>
                        <td>
                            ...
                            <script id="editor" name="notice_content" type="text/plain" style="width: 600px;height: 380px;"></script>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="notice_status" id="notice_status_1" value="1" checked required/>
                            <label for="notice_status_1">发布</label>&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="notice_status" id="notice_status_0" value="0" required/>
                            <label for="notice_status_0">不发布</label>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
                    ...
                    if (data.status == 200) {
                        ...
                        if ($('#department').length <= 0) {
                            html += '<div class="tab-pane fade in active" id="department">' +
                                '<div style="" class="nav-tabs">' +
                                '<label for="checkAll">全选</label><input type="checkbox" style="margin-right:60px;"  id= "checkAll" class="checkAll" >' +
                                '<div style="display: inline" class="checked_name">' +
                                '科室：' +
                                '</div>' +
                                '</div>' +
